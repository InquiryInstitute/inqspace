...
- [ ] 5. Implement Course Management Service
  - [x] 5.1 Create CourseManagementService with CRUD operations
  ...
  - [x] 5.2 Add course deletion with organization cleanup
  ...
  - [x] 5.3 Write property test for course-organization association
    - **Property 1: Course-Organization One-to-One Association**
    - **Validates: Requirements 1.1, 1.2, 1.3**
  
  - [x] 5.4 Write property test for course archival
    - **Property 29: Course Archival Content Preservation**
    - **Validates: Requirements 15.4**
  
  - [x] 5.5 Write unit tests for CourseManagementService
...
- [ ] 6. Implement Assignment Service
  - [x] 6.1 Create AssignmentService with assignment operations
  ...
  - [x] 6.2 Implement template repository support
...
- [ ] 7. Implement Devcontainer Parser
  - [x] 7.1 Create DevcontainerParser with parsing logic
  ...
  - [x] 7.3 Write property test for devcontainer configuration processing
    - **Property 5: Devcontainer Configuration Processing**
    - **Validates: Requirements 4.1, 4.2, 4.3**
  
  - [x] 7.4 Write property test for devcontainer error logging
    - **Property 6: Devcontainer Error Logging**
    - **Validates: Requirements 4.4**
  
  - [x] 7.5 Write unit tests for DevcontainerParser
...
- [ ] 9. Implement Grading Service
  - [x] 9.1 Create GradingService with submission operations
...
- [ ] 10. Implement Notification Service
  - [x] 10.1 Create NotificationService with notification operations
  ...
  - [x] 10.2 Add deadline notification generation
    - Implement logic to notify students of approaching deadlines
    - Filter notifications for students who haven't submitted
    - _Requirements: 12.1_
  
  - [x] 10.3 Add late submission notifications for instructors
    - Generate notifications when students submit after deadline
    - _Requirements: 12.2_
  
  - [x] 10.4 Add assignment update notifications
    - Notify students when original assignment repository is updated
    - _Requirements: 13.1_
  
  - [x] 10.5 Write property test for deadline notification generation
    - **Property 20: Deadline Notification Generation**
    - **Validates: Requirements 12.1**
  
  - [x] 10.6 Write property test for late submission instructor notification
    - **Property 21: Late Submission Instructor Notification**
    - **Validates: Requirements 12.2**
  
  - [x] 10.7 Write property test for notification read status management
    - **Property 22: Notification Read Status Management**
    - **Validates: Requirements 12.3, 12.4**
  
  - [x] 10.8 Write property test for assignment update student notification
    - **Property 23: Assignment Update Student Notification**
    - **Validates: Requirements 13.1**
  
  - [x] 10.9 Write unit tests for NotificationService
...
- [ ] 11. Implement Sync Service
  - [x] 11.1 Create SyncService with synchronization operations
  ...
  - [x] 11.2 Add merge conflict handling
    - Detect and mark conflicting files
    - Provide conflict resolution UI data
    - _Requirements: 13.4_
  
  - [x] 11.3 Write property test for fork synchronization
    - **Property 24: Fork Synchronization with Upstream**
    - **Validates: Requirements 13.3**
  
  - [x] 11.4 Write unit tests for SyncService
...
- [ ] 13. Implement REST API endpoints
  - [x] 13.1 Create course management endpoints
  ...
  - [x] 13.2 Create assignment management endpoints
  ...
  - [x] 13.3 Create submission and grading endpoints
  ...
  - [x] 13.5 Create synchronization endpoints
  ...
  - [x] 13.6 Create notification endpoints
...
- [ ] 14. Implement environment setup functionality
  - [x] 14.1 Create environment setup service
  ...
  - [x] 14.2 Add Docker image and feature handling
  ...
  - [x] 14.3 Add error handling and recovery
  ...
  - [x] 14.4 Write property test for environment setup with dependencies
    - **Property 15: Environment Setup with Dependencies**
    - **Validates: Requirements 9.1, 9.2**
  
  - [x] 14.5 Write property test for environment setup progress tracking
    - **Property 16: Environment Setup Progress Tracking**
    - **Validates: Requirements 9.3**
  
  - [x] 14.6 Write unit tests for environment setup
...
- [ ] 17. Implement configuration change notifications
  - [x] 17.1 Add notification logic for configuration changes
    - Detect configuration changes affecting student repositories
    - Generate instructor notifications for impactful changes
    - _Requirements: 5.4_
  
  - [x] 17.2 Write property test for configuration change notifications
    - **Property 9: Configuration Change Notifications**
    - **Validates: Requirements 5.4**
  
  - [x] 17.3 Write unit tests for configuration change notifications
...
- [ ] 18. Final integration and wiring
  ...
  - [x] 18.3 Configure logging and monitoring
...
- [ ] 20. Implement VS Code IDE embedding and scripting
  - [ ] 20.1 Create devcontainer configuration for VS Code server
    - Add code-server or OpenVSCode Server installation to devcontainer
    - Configure postStartCommand to start VS Code server on port 8080
    - Configure MCP control server to start on port 8765
    - Set port forwarding for both ports
    - _Requirements: 16.1, 16.2, 16.3_
  
  - [ ] 20.2 Implement MCP control server
    - Create HTTP server implementing MCP JSON-RPC protocol
    - Add /mcp endpoint for receiving commands
    - Implement origin validation and authentication
    - Add health check endpoint
    - _Requirements: 16.5, 16.8, 16.9_
  
  - [ ] 20.3 Create VS Code extension for MCP integration
    - Implement command registration for editor actions
    - Add connection to MCP server for receiving commands
    - Implement openFile, runTask, focusTerminal, highlightText commands
    - Add WebSocket/SSE polling for command updates
    - _Requirements: 16.6, 16.7_
  
  - [ ] 20.4 Add iframe embedding support
    - Configure code-server to allow iframe embedding (remove X-Frame-Options)
    - Set trustedOrigins to include lecture page domain
    - Test iframe loading from external lecture page
    - _Requirements: 16.4_
  
  - [ ] 20.5 Implement health check and recovery
    - Add periodic health checks via GitHub API
    - Implement MCP ping command for connectivity verification
    - Add auto-restart/recreation on failure detection
    - _Requirements: 16.10_
  
  - [ ] 20.6 Write property test for VS Code IDE embedding
    - **Property 30: VS Code IDE Embedding and Scripting**
    - **Validates: Requirements 16.1-16.10**
  
  - [ ] 20.7 Write unit tests for MCP server and extension
    - Test MCP command handling and validation
    - Test VS Code API integration
    - Test authentication and origin validation
